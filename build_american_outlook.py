...
def collect_group_evidence(
    ...
    return {
        ...
        "tensions": dedupe([simplify_tension(item) for item in evidence["tensions"]], 3),
        "second_order_effects": dedupe([simplify_second_order(item) for item in evidence["second_order_effects"]], 2),
        "operator_implications": dedupe([simplify_implication(item) for item in evidence["operator_implications"]], 4),
        "capital_implications": dedupe([simplify_implication(item) for item in evidence["capital_implications"]], 4),
...
<body><div class="wrap">
<div class="top"><a href="american-synthesis-hub.html">Synthesis hub</a><a href="index.html">Industry briefs</a><a href="american-rankings.html">Rankings</a><a href="american-executive-summary.html">Executive summary</a><a href="economic-intelligence.html">Economic intelligence</a><a href="american-themes.html">American themes</a><a href="american-economy-2025-2026.html">Capstone</a><a href="american-synthesis-playbook.html">Playbook</a></div>
