export const meta = {
  name: 'forces-writeups-t2r',
  description: 'Write all subforce pages across the 14 data-grounded force collections (evidence-grounded)',
  phases: [{ title: 'Write' }],
}
const SPECS = [{"slug": "insuring-the-ev", "title": "Insuring the EV", "group": "C \u00b7 The ripple effects", "pack": "/home/manishmehta/ui-projects/ibis-industries/_packs/the-electrification__insuring-the-ev.txt", "cap": false, "force": "the-electrification", "ftitle": "The Electrification", "sig": "The car goes electric and software-defined \u2014 and the whole century-old machine of engines, transmissions, gas, and exhaust starts dying while batteries, chips, and copper take over."}];
const SCHEMA = {
  type:'object',
